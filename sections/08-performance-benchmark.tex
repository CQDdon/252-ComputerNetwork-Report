...
\begin{itemize}[leftmargin=2em]
    \item Mỗi peer được chạy như một tiến trình (process) Python độc lập.
    \item Một tiến trình tracker được dùng cho discovery và quản lý membership.
    \item Cả hai chế độ đều chạy trên cùng một máy.
    \item Authentication được tắt hoặc được bỏ qua (bypass) cho mục đích benchmark (nếu áp dụng).
